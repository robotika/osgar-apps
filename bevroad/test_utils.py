...
class TestTransformAndCoordinateMath(unittest.TestCase):
...
class TestJsonConfig(unittest.TestCase):
    ...
    def test_load_calibration_non_existent(self):
        non_existent_path = os.path.join(self.test_dir.name, 'does_not_exist.json')
        with self.assertRaises(SystemExit):
            load_calibration(non_existent_path)
